...
// Method Imports
import { BACKEND_ENDPOINT, getFriendRequests, getStatusByUsername, getAccountbyUsername, handleFriendRequest, logout, sendFriendRequest, updateAccountbyUsername, getFriendRequest, getFriendsClasses, uploadPP } from "../../APIFolder/loginApi";
            ...
            {JSON.parse(localStorage.getItem("currUser")).username === account.username && editMode === true &&
                <div className="container border-0 mt-5">
                    <div className="row bg-light pb-4">
                        {account.pfp_url !== undefined && <img src={`${BACKEND_ENDPOINT}/static/${account.pfp_url}`} className="float-start col-4 m-3 mt-5 pb-5" alt="" />}
